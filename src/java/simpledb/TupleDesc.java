...
public class TupleDesc implements Serializable {
    ...
    public String getFieldName(int i) throws NoSuchElementException {
        // some code goes here
        if(i>=numFields()) throw new NoSuchElementException("No field name at index: "+i);
    ...
    public Type getFieldType(int i) throws NoSuchElementException {
        // some code goes here
        if(i>=numFields()) throw new NoSuchElementException("No field type at index: "+i);
    ...
    public boolean equals(Object o) {
        ...
        for(int i=0;i<this.numFields();i++){
            if(!this.getFieldType(i).equals(temp.getFieldType(i))) return false;
        }
        return true;
    }
